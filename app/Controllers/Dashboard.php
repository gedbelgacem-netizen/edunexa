...
class Dashboard extends Security_Controller {
    ...
    function view($id = 0) {
        ...
        // --------------------------------------------------------------------
        // EDUNEXA PHASE 0 HOTFIX: Safety net
        // Client users must not enter staff dashboard management views.
        // If a client hits /dashboard/view, send them back to /dashboard.
        // --------------------------------------------------------------------
